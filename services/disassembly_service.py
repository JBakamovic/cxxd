...
class Disassembly(cxxd.service.Service):
    ...
    def _list_targets(self, args):
        ...
        # This check is needed because bazel literally chmod a+x _all_ the files in its build cache - yes,
        # that will include literally anything, from the source code, to headers, to .md files, to json or
        # yaml files, CMake build scripts, Bazel build scripts ... everything. Not sure is it a "feature"
        # by design or simply a bug.
