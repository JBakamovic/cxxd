    ...
    class JSONCompilationDatabase():
        ...
        def get(self, filename):
            ...
            def eat_conflicting_input_file(json_comp_db_command, filename):
                ...
                # We need to remove it from the args list.
                # We check for exact match or basename match or abspath match.
                # NOTE: os.path.exists checks might be slow but we only do string comparison here.
                # However, to be robust against relative paths:
